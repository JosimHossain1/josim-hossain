...
const About = () => {
  return (
    <div>
      <div className='mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl px-4 md:px-24 lg:px-8 pb-16 md:flex justify-between items-center md:space-x-10 '>
        {/* Image Side */}
        ...
        <div className='flex-1 border-l-2 border-slate-800 pl-10'>
          <h1 className='text-xl  text-[#8E60F8] poppins-semibold my-4  text-left'>
            ABOUT ME
          </h1>
          <p className='text-indigo-200 text-[15px] text-left'>
